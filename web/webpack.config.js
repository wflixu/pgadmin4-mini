...
const pgadminThemesJson =
  __dirname + "/pgadmin/misc/themes/pgadmin.themes.json";
...
const sourceMapDevToolPlugin = new webpack.SourceMapDevToolPlugin({
  ...
  exclude:
    /(vendor|codemirror|pgadmin\.js|pgadmin.theme|pgadmin.static|style\.js|popper)/,
  columns: false,
});
...
let getThemeWebpackConfig = function (theme_name) {
  return {
    ...
    plugins: [extractStyle, sourceMapDevToolPlugin],
  };
};
...
module.exports = [
  {
      ...
      splitChunks: {
        cacheGroups: {
          vendor_main: {
            ...
            enforce: true,
            test(module) {
              return webpackShimConfig.matchModules(module, [
                "wcdocker",
                "jquery",
                "bootstrap",
                "popper",
    ...
    plugins: PRODUCTION
      ...
      : [extractStyle, providePlugin, sourceMapDevToolPlugin, copyFiles],
  },
